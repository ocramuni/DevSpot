...
namespace DevSpot.Copilot.AcceptanceTests.Features.JobPosting
{
    ...
    public partial class VisualizzazioneOfferteDiLavoroFeature : object, global::Xunit.IClassFixture<VisualizzazioneOfferteDiLavoroFeature.FixtureData>, global::Xunit.IAsyncLifetime
    {
        ...
        private static global::Reqnroll.FeatureInfo featureInfo = new global::Reqnroll.FeatureInfo(new global::System.Globalization.CultureInfo("it"), "Features/JobPosting", "Visualizzazione offerte di lavoro", "  In qualità di visitatore o utente autenticato\n  Voglio visualizzare le offerte " +
...
#line hidden
        ...
        public VisualizzazioneOfferteDiLavoroFeature(VisualizzazioneOfferteDiLavoroFeature.FixtureData fixtureData, global::Xunit.Abstractions.ITestOutputHelper testOutputHelper)
        {
        ...
        {
            return new global::Reqnroll.Formatters.RuntimeSupport.FeatureLevelCucumberMessages("Features/JobPosting/ViewJobPostings.feature.ndjson", 6);
        }
        ...
        [global::Xunit.TraitAttribute("FeatureTitle", "Visualizzazione offerte di lavoro")]
...
#line hidden
        ...
        public class FixtureData : object, global::Xunit.IAsyncLifetime
        {
            ...
            async global::System.Threading.Tasks.Task global::Xunit.IAsyncLifetime.InitializeAsync()
            {
                await VisualizzazioneOfferteDiLavoroFeature.FeatureSetupAsync();
            }
            
            async global::System.Threading.Tasks.Task global::Xunit.IAsyncLifetime.DisposeAsync()
            {
                await VisualizzazioneOfferteDiLavoroFeature.FeatureTearDownAsync();
            }
        }
    }
}
